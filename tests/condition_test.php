...
class availability_mobileapp_condition_testcase extends advanced_testcase {
    ...
    public function test_completion_value_used() {
        ...
        availability_mobileapp\condition::wipe_static_cache();
        ...
        $this->assertTrue(availability_mobileapp\condition::completion_value_used(
                $course, $page1->cmid));
        $this->assertTrue(availability_mobileapp\condition::completion_value_used(
                $course, $page2->cmid));
        $this->assertFalse(availability_mobileapp\condition::completion_value_used(
                $course, $page3->cmid));
    }
